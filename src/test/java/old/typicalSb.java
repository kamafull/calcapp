...
public class typicalSb {
    ...
    public typicalSb(int id_user, int type, String name, String json_string, int amount_incb, int insw_switch, int insw_in, int pmeter_need, int pmeter_net, int insw_am, circuitbreaker incb, ArrayList<circuitbreaker> list_outcb, enclosure ecs, int ecs_incab, int ecs_outcab, int ecs_busbar ) throws SQLException {
        ...
        this.insw_switch = insw_switch;
        this.insw_in = insw_in;
        this.pmeter_need = pmeter_need;
        this.pmeter_net = pmeter_net;
        this.insw_am = insw_am;
        this.incb = incb;
        this.list_outcb = list_outcb;
        this.ecs = ecs;
        this.ecs_incab = ecs_incab;
        this.ecs_outcab = ecs_outcab;
        this.ecs_busbar = ecs_busbar;
